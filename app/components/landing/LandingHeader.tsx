...
const navItems = [
  ...
  { href: "#directive", label: "Release readiness" },
...
export function LandingHeader({
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/6 bg-[#06100d]/78 backdrop-blur-xl">
      ...
      <div
        className={clsx(
          "overflow-hidden border-t border-white/6 bg-[#07110e]/95 transition-[max-height,opacity] duration-300 lg:hidden",
